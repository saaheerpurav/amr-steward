...
Usage:
    ...
    python submit_train_job.py --token hf_xxx --hardware a10g-large --model Qwen/Qwen3-4B
    python submit_train_job.py --token hf_xxx --delete   # delete Space when done

Hardware options and hourly cost:
    t4-medium     ~$0.60/hr  (T4 16GB)   — Qwen3-1.5B fits, ~90 min
    a10g-small    ~$1.05/hr  (A10G 24GB) — Qwen3-1.5B fast, ~45 min
    a10g-large    ~$3.15/hr  (A10G 40GB) — Qwen3-4B fits, ~60 min
    a100-large    ~$7.60/hr  (A100 80GB) — Qwen3-4B fastest, ~40 min
"""
